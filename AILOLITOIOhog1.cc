 ...
 */
#define PLAYER_NAME LOLITOIOhog1
    ...
    for(int a=0;a<np;++a) {
      ...
      if(dist2!=-1 and d!=c+Up) {
        if(pp==c) priocomandos.emplace(make_pair(-1,make_pair(dist3,pr)),make_pair(Pi[P[a]],Up));
          ...
          if(a1==c and disa1<=dist2) priocomandos.emplace(make_pair(-1,make_pair(disa1+dist3,pr)),make_pair(Pi[P[a]],dia1));
          else if(a2==c and disa2<=dist2) priocomandos.emplace(make_pair(-1,make_pair(disa2+dist3,pr)),make_pair(Pi[P[a]],dia2));
          else if(a3==c and disa3<=dist2) priocomandos.emplace(make_pair(-1,make_pair(disa3+dist3,pr)),make_pair(Pi[P[a]],dia3));
          else if(a0==c and disa<=dist2) priocomandos.emplace(make_pair(-1,make_pair(disa+dist3,pr)),make_pair(Pi[P[a]],dia));
