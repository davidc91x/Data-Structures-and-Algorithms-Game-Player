        ...
        if(c.type!=Rock and c.id==-1) priocomandos.emplace(make_pair(5,make_pair(dist,0)),make_pair(Pi[P[a]],contrary(di)));
          ...
          int o=contrary(di);
           ...
           if(c.type!=Rock and c.id==-1) priocomandos.emplace(make_pair(5,make_pair(dist,0)),make_pair(Pi[P[a]],Dir(o+1)));
             ...
             c=cell(pp+Dir(o-1));
           if(c.type!=Rock and c.id==-1) priocomandos.emplace(make_pair(5,make_pair(dist,0)),make_pair(Pi[P[a]],Dir(o-1)));
           else if(cell(pp+Dir(o)).type!=Rock and unit(cell(pp+Dir(o)).id).type==Pioneer) priocomandos.emplace(make_pair(5,make_pair(dist,0)),make_pair(Pi[P[a]],Dir(o)));
          else if(cell(pp+Dir(o+1)).type!=Rock and unit(cell(pp+Dir(o+1)).id).type==Pioneer) priocomandos.emplace(make_pair(5,make_pair(dist,0)),make_pair(Pi[P[a]],Dir(o+1)));
          else if(cell(pp+Dir(o-1)).type!=Rock and unit(cell(pp+Dir(o-1)).id).type==Pioneer) priocomandos.emplace(make_pair(5,make_pair(dist,0)),make_pair(Pi[P[a]],Dir(o-1)));
            else if(cell(pp+Dir(o)).type!=Rock ) priocomandos.emplace(make_pair(5,make_pair(dist,0)),make_pair(Pi[P[a]],Dir(o)));
          else if(cell(pp+Dir(o+1)).type!=Rock) priocomandos.emplace(make_pair(5,make_pair(dist,0)),make_pair(Pi[P[a]],Dir(o+1)));
          else if(cell(pp+Dir(o-1)).type!=Rock ) priocomandos.emplace(make_pair(5,make_pair(dist,0)),make_pair(Pi[P[a]],Dir(o-1)));
          }
        }
      }
