...
return None;
    ...
    void cargarataques(){
      ...
      for (int i = 0; i < nf; ++i) {
        ...
        if(pf==b2 and pf==b and e!=pf){
          Cell c=cell(pf+contrary(di));
        if(c.type!=Rock and c.id==-1) priocomandos.emplace(make_pair(5,make_pair(dist,0)),make_pair(Fu[F[i]],contrary(di)));
        else {
          int o=contrary(di);
           c=cell(pf+Dir(o+1));
           if(c.type!=Rock and c.id==-1) priocomandos.emplace(make_pair(5,make_pair(dist,0)),make_pair(Fu[F[i]],Dir(o+1)));
           else {
             c=cell(pf+Dir(o-1));
           if(c.type!=Rock and c.id==-1) priocomandos.emplace(make_pair(5,make_pair(dist,0)),make_pair(Fu[F[i]],Dir(o-1)));
            else if(cell(pf+Dir(o)).type!=Rock and unit(cell(pf+Dir(o)).id).type==Pioneer) priocomandos.emplace(make_pair(5,make_pair(dist,0)),make_pair(Fu[F[i]],Dir(o)));
          else if(cell(pf+Dir(o+1)).type!=Rock and unit(cell(pf+Dir(o+1)).id).type==Pioneer) priocomandos.emplace(make_pair(5,make_pair(dist,0)),make_pair(Fu[F[i]],Dir(o+1)));
          else if(cell(pf+Dir(o-1)).type!=Rock and unit(cell(pf+Dir(o-1)).id).type==Pioneer) priocomandos.emplace(make_pair(5,make_pair(dist,0)),make_pair(Fu[F[i]],Dir(o-1)));
            else if(cell(pf+Dir(o)).type!=Rock ) priocomandos.emplace(make_pair(5,make_pair(dist,0)),make_pair(Fu[F[i]],Dir(o)));
          else if(cell(pf+Dir(o+1)).type!=Rock) priocomandos.emplace(make_pair(5,make_pair(dist,0)),make_pair(Fu[F[i]],Dir(o+1)));
          else if(cell(pf+Dir(o-1)).type!=Rock ) priocomandos.emplace(make_pair(5,make_pair(dist,0)),make_pair(Fu[F[i]],Dir(o-1)));
